(function () {
    ...
    function DashboardApp(props) {
        ...
        var transactions = [
            {
                id: 'TRX-00101',
                datetime: '2025-10-22 11:45 AM',
                cashier: 'Fyra Nika Dudas',
                total: '3,500.00',
                status: 'Completed'
            }
        ];
                    ...
                    e('table', { className: 'data-table' }, [
                        ...
                        e('tbody', { key: 'tbody' }, transactions.map(function (transaction) {
                            return e('tr', { key: transaction.id }, [
                                ...
                                e('td', null, transaction.datetime),
                                e('td', null, transaction.cashier),
                                e('td', null, transaction.total),
                                e('td', null, e('span', { className: 'status-badge success' }, transaction.status)),
                                e('td', null, [
                                    e('button', {
                                        className: 'action-icon view-btn',
                                        type: 'button',
                ...
                e('div', { className: 'table-container', key: 'table' }, [
                    e('table', { className: 'data-table' }, [
                        ...
                        e('tbody', { key: 'tbody' }, applicants.map(function (applicant, idx) {
                            return e('tr', { key: idx }, [
                                e('td', null, applicant.name),
                                e('td', null, applicant.position),
                                e('td', null, applicant.date),
                                e('td', null, e('span', { className: 'status-badge warning' }, applicant.status)),
                                e('td', null, [
                                    e('button', {
